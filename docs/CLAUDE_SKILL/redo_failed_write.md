...
os.chdir('/g/data/jk53/jinzhu/LUTO/Custom_runs/<ITER>/Run_G000X')

import luto.simulation as sim
from luto.tools.write import write_outputs

data = sim.load_data_from_disk('/path/to/Data_RES5.lz4')
write_outputs(data)
```
...
- `#PBS -o/-e` with absolute paths keeps logs in the run dir
