...
def crossmap_irrstat( lumap_old
    ...
    crosstab[['From land-use','From water_supply', 'tmp']] = crosstab['level_0'].str.split(' \(', expand=True)
    crosstab[['To land-use', 'To water_supply', 'tmp']] = crosstab['level_1'].str.split(' \(', expand=True)
