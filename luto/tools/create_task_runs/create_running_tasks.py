...
os.environ["GRB_LICENSE_FILE"] = "/home/582/jw6041/gurobi_lic_compute_2/gurobi.lic"
...
#     'RESFACTOR': [3],
#     'SIM_YERAS': [list(np.arange(2010,2051))],   # Years to run the model 
#     'WRITE_THREADS': [5],
...
create_task_runs(grid_search_df, mode='single', n_workers=12)
