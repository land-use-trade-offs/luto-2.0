   ...
   */ (function (t, e) {
        "object" == typeof exports && "object" == typeof module
            ...
            : "function" == typeof define && define.amd
                ...
                : "object" == typeof exports
                    ? (exports["highcharts/modules/heatmap"] = e(
                        t._Highcharts,
                        t._Highcharts.Axis,
                        t._Highcharts.Color,
                        t._Highcharts.LegendSymbol,
        ...
        (() => {
            ...
            var g = c(944),
                ...
                b = c.n(y);
            let { parse: v } = b(),
                { addEvent: C, extend: A, merge: M, pick: w, splat: L } = m();
            !(function (t) {
                let e;
                function s() {
                ...
                function i(t) {
                    let e = this.chart.colorAxis || [],
                        s = (e) => {
                            ...
                            -1 !== s &&
                                (this.destroyItem(t.allItems[s]), t.allItems.splice(s, 1));
                        },
                        i = [],
                        o,
                        r;
                        ...
                        e.forEach(function (t) {
                            ((o = t.options),
                                ...
                                (o.dataClasses && o.visible
                                    ? (i = i.concat(t.getDataClassLegendSymbols()))
                                    : o.visible && i.push(t),
                        ...
                        ((e = t),
                            ...
                            (function (t) {
                                ...
                                t.prototype.createAxis = function (t, i) {
                                    ...
                                    let o = new e(
                                        this,
                                        M(i.axis, { index: this[t].length, isX: !1 }),
                                    );
                                    return (
                                        ...
                                        w(i.redraw, !0) && this.redraw(i.animation),
                                        o
                                    );
                                };
                            })(c),
                            (x.fillSetter = d),
                            (x.strokeSetter = p),
                            C(g, "afterGetAllItems", i),
                            C(g, "afterColorizeItem", o),
                            C(g, "afterUpdate", r),
                            A(y, { optionalAxis: "colorAxis", translateColors: h }),
                            A(y.pointClass.prototype, { setVisible: n }),
                            C(m, "afterTranslate", l, { order: 1 }),
                            C(m, "bindAxes", a));
                }),
                    (t.pointSetVisible = n));
            })(a || (a = {}));
                    ...
                    for (let t = 0, s = o.length; t < s; ++t)
                        ((r = S((r = o[t]))),
                            ...
                            ("category" === i.dataClassColor
                                ? (e.styledMode ||
                                    ((a = (h = e.options.colors || []).length),
                                        (r.color = h[n])),
                                    (r.colorIndex = n),
                                    ++n === a && (n = 0))
                                : (r.color = I(i.minColor).tweenTo(
                                    I(i.maxColor),
                                    s < 2 ? 0.5 : t / (s - 1),
                                ))));
                }),
                        ...
                        if (n) {
                            for (a = n.length; a--;)
                                if (
                                    ...
                                    ((r = l.color),
                                        e && ((e.dataClass = a), (e.colorIndex = l.colorIndex)));
                                    break;
                                }
                        } else {
                            for (
                                s = this.normalizedValue(t), a = h.length;
                                a-- && !(s > h[a][0]);
                            );
                            ((i = h[a] || h[a + 1]),
                                (s = 1 - ((o = h[a + 1] || i)[0] - s) / (o[0] - i[0] || 1)),
                                (r = i.color.tweenTo(o.color, s)));
                        }
                        return r;
                    }));
            })(n || (n = {}));
            ...
            class j extends x() {
                ...
                init(t, e) {
                    ...
                    ((this.side = e.side || i ? 2 : 1),
                        (this.reversed = e.reversed || !i),
                        (this.opposite = !i),
                        super.init(t, e, "colorAxis"),
                        (this.userOptions = e),
                        _(t.userOptions.colorAxis) &&
                ...
                setAxisSize() {
                    let t = this.chart,
                        ...
                        { width: s, height: i } = this.getSize();
                    (e &&
                        ((this.left = +e.attr("x")),
                            (this.top = +e.attr("y")),
                            (this.width = s = +e.attr("width")),
                            (this.height = i = +e.attr("height")),
                            (this.right = t.chartWidth - this.left - s),
                            (this.bottom = t.chartHeight - this.top - i),
                            (this.pos = this.horiz ? this.left : this.top)),
                        (this.len = (this.horiz ? s : i) || j.defaultLegendLength));
                }
                getOffset() {
                ...
                drawLegendSymbol(t, e) {
                    ...
                    (this.setLegendColor(),
                        ...
                        (s.labelWidth =
                            n +
                            i +
                            (a ? l : K(r.x, r.distance) + (this.maxLabelLength || 0))),
                        (s.labelHeight = h + i + (a ? d : 0)));
                }
                setState(t) {
                ...
                getSeriesExtremes() {
                    ...
                    for (this.dataMin = 1 / 0, this.dataMax = -1 / 0; r--;) {
                        ...
                        if (i)
                            ((o.minColorValue = o[s + "Min"]),
                                (o.maxColorValue = o[s + "Max"]));
                        else {
                        ...
                        (z(o.minColorValue) &&
                            ...
                            i || O.prototype.applyExtremes.call(o));
                    }
                }
                drawCrosshair(t, e) {
                    let s,
                        ...
                        a = this.len;
                    e &&
                        ((s = this.toPixels(e.getNestedProperty(e.series.colorKey))) < l
                            ? (s = l - 2)
                            : s > l + a && (s = l + a + 2),
                            (e.plotX = s),
                            (e.plotY = this.len - s),
                            ...
                            i.group &&
                            (this.cross.addClass("highcharts-coloraxis-marker").add(i.group),
                ...
                getPlotLinePath(t) {
                    ...
                    return W(s)
                        ? this.horiz
                            ? [["M", s - 4, i - 6], ["L", s + 4, i - 6], ["L", s, i], ["Z"]]
                            : [["M", e, s], ["L", e - 6, s + 6], ["L", e - 6, s - 6], ["Z"]]
                ...
                update(t, e) {
                    ...
                    (this.series.forEach((t) => {
                        ...
                        ((t.dataClasses && s.allItems) || this.dataClasses) &&
                        this.destroyItems(),
                        super.update(t, e),
                        this.legendItem?.label &&
                        (this.setLegendColor(), s.colorizeItem(this, !0)));
                }
                destroyItems() {
                    let t = this.chart,
                        e = this.legendItem || {};
                    if (e.label) t.legend.destroyItem(this);
                    else if (e.labels) for (let s of e.labels) t.legend.destroyItem(s);
                    t.isDirtyLegend = !0;
                }
                destroy() {
                ...
                getDataClassLegendSymbols() {
                    let t,
                        ...
                        a = (t) =>
                            e.series.reduce(
                                (e, s) => (
                                    e.push(...s.points.filter((e) => e.dataClass === t)),
                                    e
                                ),
                                [],
                            );
                ...
                getSize() {
                    let { chart: t, horiz: e } = this,
                        { height: s, width: i } = this.options,
                        { legend: o } = t.options;
                    return {
                        width: K(
                            z(i) ? X(i, t.chartWidth) : void 0,
                            o?.symbolWidth,
                            e ? j.defaultLegendLength : 12,
                        ),
                        height: K(
                            z(s) ? X(s, t.chartHeight) : void 0,
                            o?.symbolHeight,
                            e ? 12 : j.defaultLegendLength,
                        ),
                    };
                }
            }
            ((j.defaultLegendLength = 200),
                (j.keepProps = ["legendItem"]),
                R(j.prototype, P),
                Array.prototype.push.apply(x().keepProps, j.keepProps));
            let F = m();
            ((F.ColorAxis = F.ColorAxis || j),
                F.ColorAxis.compose(F.Chart, F.Fx, F.Legend, F.Series));
            var U = c(28),
                Y = c.n(U);
            let {
                column: { prototype: Z },
            } = V().seriesTypes,
                { addEvent: q, defined: $ } = m();
            !(function (t) {
                function e(t) {
                    let e = this.series,
                        s = e.chart.renderer;
                    this.moveToTopOnHover &&
                        ...
                        (e.stateMarkerGraphic ||
                            (e.stateMarkerGraphic = new (Y())(s, "use")
            ...
            let B = h,
                {
                    scatter: {
                        prototype: { pointClass: J },
                    },
                } = V().seriesTypes,
                { clamp: Q, defined: tt, extend: te, pick: ts } = m();
            class ti extends J {
                applyOptions(t, e) {
                    return (
                ...
                getCellAttributes() {
                    let t = this.series,
                        ...
                        h = {
                            x1: Q(
                                Math.round(o.len - o.translate(this.x - s, !1, !0, !1, !0, -a)),
                                -o.len,
                                2 * o.len,
                            ),
                            x2: Q(
                            ...
                            y1: Q(
                                Math.round(r.translate(this.y - i, !1, !0, !1, !0)),
                                -r.len,
                                2 * r.len,
                            ),
                            y2: Q(
            ...
            var tr = c(540),
                tl = c.n(tr);
            let { doc: ta } = m(),
                { defined: tn, pick: th } = m(),
                {
                    series: td,
                    seriesTypes: { column: tp, scatter: tc },
                } = V(),
                {
                    prototype: { symbols: tu },
                } = tl(),
                {
                    addEvent: tg,
                    extend: tm,
                ...
                { colorFromPoint: tv, getContext: tC } = {
                    colorFromPoint: function (t, e) {
                        ...
                        if (s) {
                            let i = s
                                ...
                                .split("(")[1]
                                .split(",")
                                .map((t) => th(parseFloat(t), parseInt(t, 10)));
                            return (
                                (i[3] = 255 * th(i[3], 1)),
                                (tn(t) && e.visible) || (i[3] = 0),
                                i
                            );
                        }
                        return [0, 0, 0, 0];
                    ...
                    getContext: function (t) {
                        let { canvas: e, context: s } = t;
                        return e && s
                            ? (s.clearRect(0, 0, e.width, e.height), s)
                            : ((t.canvas = ta.createElement("canvas")),
                                (t.context =
            ...
            class tA extends tc {
                ...
                drawPoints() {
                    let t = this,
                        ...
                        i = e.marker || {};
                    if (s) {
                        let { image: e, chart: s, xAxis: i, yAxis: o } = t,
                            { reversed: r = !1, len: l } = i,
                            { reversed: a = !1, len: n } = o,
                            h = { width: l, height: n };
                        if (!e || t.isDirtyData || t.isDirtyCanvas) {
                            let l = tC(t),
                                {
                                    canvas: n,
                                    options: { colsize: d = 1, rowsize: p = 1 },
                                    points: c,
                                    points: { length: u },
                                } = t,
                                g = s.colorAxis && s.colorAxis[0];
                            if (n && l && g) {
                                let { min: g, max: m } = i.getExtremes(),
                                ...
                                (l.putImageData(new ImageData(I, w), 0, 0),
                                    e
                                        ? e.attr({ ...h, href: n.toDataURL("image/png", 1) })
                                        : ((t.directTouch = !1),
                                            (t.image = s.renderer
                                                .image(n.toDataURL("image/png", 1))
                                                .attr(h)
                                                .add(t.group))));
                            }
                            t.isDirtyCanvas = !1;
                        ...
                        (i.enabled || t._hasPointMarkers) &&
                            (td.prototype.drawPoints.call(t),
                                t.points.forEach((e) => {
                                    e.graphic &&
                ...
                getExtremes() {
                    let { dataMin: t, dataMax: e } = td.prototype.getExtremes.call(
                        this,
                        this.getColumn("value"),
                    );
                    return (
                        tx(t) && (this.valueMin = t),
                        tx(e) && (this.valueMax = e),
                        td.prototype.getExtremes.call(this)
                    );
                }
                getValidPoints(t, e) {
                ...
                init() {
                    ...
                    let t = this.options;
                    ((t.pointRange = tb(t.pointRange, t.colsize || 1)),
                        (this.yAxis.axisPointRange = t.rowsize || 1),
                        (tu.ellipse = tu.circle),
                        t.marker && tx(t.borderRadius) && (t.marker.r = t.borderRadius));
                }
                markerAttribs(t, e) {
                    let s = t.shapeArgs || {};
                    ...
                    if (e && "normal" !== e) {
                        let i = t.options.marker || {},
                            ...
                            l = i.states?.[e] || {},
                            a =
                                (l.width || r.width || s.width || 0) +
                                (l.widthPlus || r.widthPlus || 0),
                            n =
                                (l.height || r.height || s.height || 0) +
                                (l.heightPlus || r.heightPlus || 0);
                        return {
                ...
                pointAttribs(t, e) {
                    ...
                    if (
                        ((s.stroke =
                            t?.marker?.lineColor || i.marker?.lineColor || a || this.color),
                            (s["stroke-width"] = n),
                            e && "normal" !== e)
                    ) {
                        let o = ty(
                ...
                translate() {
                    ...
                    for (let e of (this.generatePoints(), this.points)) {
                        ...
                        if (
                            ((e.hasImage =
                                0 === (e.marker?.symbol || s || "").indexOf("url")),
                                o)
                        ) {
                            let t = Math.abs(n - h);
                            ((l = Math.min(r.x1, r.x2) + (n < h ? 0 : t / 2)),
                                (a = Math.min(r.y1, r.y2) + (n < h ? t / 2 : 0)),
                                (n = h = Math.min(n, h)));
                        }
                        (e.hasImage && (e.marker = { width: n, height: h }),
                            (e.plotX = e.clientX = (r.x1 + r.x2) / 2),
                            (e.plotY = (r.y1 + r.y2) / 2),
                            (e.shapeType = "path"),
                            (e.shapeArgs = ty(
                                !0,
                                { x: l, y: a, width: n, height: h },
                                { d: tu[i](l, a, n, h, { r: tx(t) ? t : 0 }) },
                            )));
                    }
            ...
            ((tA.defaultOptions = ty(tc.defaultOptions, {
                ...
                B.compose(tA),
                V().registerSeriesType("heatmap", tA));
      /**
