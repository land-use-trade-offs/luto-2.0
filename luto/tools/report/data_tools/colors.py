import itertools
from luto.tools.report.data_tools.parameters import LANDUSE_ALL,COMMODITIES_ALL,GHG_NAMES
...
LANDUSE_ALL_COLORS = dict(zip(LANDUSE_ALL, itertools.cycle(COLORS)))
