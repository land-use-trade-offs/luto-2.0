...
class LutoSolver:
    ...
    def _add_GBF4_species_conservation_constraints(self) -> None:
        ...
        for s, s_area_lb in enumerate(s_limits):
            ...
            ind = s_ind[s]
            GBF4_raw_area_r = self._input_data.GBF8_raw_species_area_sr[s, ind]
        ...
        for x, x_area_lb in enumerate(x_limits):
            ...
            if ind.size == 0:
                print(
                    ...
                    f"(data.get_GBF4_SNES_layers() returns empty array for this species).")
                continue
        ...
        for x, x_area_lb in enumerate(x_limits):
            ...
            if ind.size == 0:
                print(
                    ...
                    f"(data.get_GBF4_ECNES_layers() returns empty array for this community).")
                continue
