...
def get_cost_rip_plantings(data) -> np.ndarray:
    ...
    # yearly maintenance cost of rp applied to each cell and adjusted for resfactor
    return rp_maintenance_cost * data.REAL_AREA + data.RIPARIAN_PLANTINGS_FENCING_COST
