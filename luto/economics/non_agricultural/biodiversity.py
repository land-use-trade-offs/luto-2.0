...
def get_biodiv_environmental_plantings(data: Data) -> np.ndarray:
    return data.BIODIV_SCORE_RAW_WEIGHTED_CRITICAL_AREA * data.REAL_AREA * ENV_PLANTING_BIODIVERSITY_BENEFIT


def get_biodiv_riparian_plantings(data: Data) -> np.ndarray:
    return data.BIODIV_SCORE_RAW_WEIGHTED_CRITICAL_AREA * data.REAL_AREA * RIPARIAN_PLANTING_BIODIV_BENEFIT


def get_biodiv_agroforestry_base(data: Data) -> np.ndarray:
    return data.BIODIV_SCORE_RAW_WEIGHTED_CRITICAL_AREA * data.REAL_AREA * AGROFORESTRY_BIODIV_BENEFIT
...
def get_biodiv_carbon_plantings_block(data: Data) -> np.ndarray:
    return data.BIODIV_SCORE_RAW_WEIGHTED_CRITICAL_AREA * data.REAL_AREA * CARBON_PLANTING_BLOCK_BIODIV_BENEFIT


def get_biodiv_carbon_plantings_belt_base(data: Data) -> np.ndarray:
    return data.BIODIV_SCORE_RAW_WEIGHTED_CRITICAL_AREA * data.REAL_AREA * CARBON_PLANTING_BELT_BIODIV_BENEFIT
...
def get_biodiv_beccs(data: Data):
    return data.BIODIV_SCORE_RAW_WEIGHTED_CRITICAL_AREA * data.REAL_AREA * BECCS_BIODIVERSITY_BENEFIT
