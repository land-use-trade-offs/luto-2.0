...
def get_agricultural_management_cost_matrices(data, c_mrj, yr_idx):
    ...
    if 'Asparagopsis taxiformis' in AG_MANAGEMENTS_TO_LAND_USES:
        ag_management_data['Asparagopsis taxiformis'] = get_asparagopsis_effect_c_mrj(data, yr_idx)
    if 'Precision Agriculture' in AG_MANAGEMENTS_TO_LAND_USES:
        ag_management_data['Precision Agriculture'] = get_precision_agriculture_effect_c_mrj(data, yr_idx)
    if 'Ecological Grazing' in AG_MANAGEMENTS_TO_LAND_USES:
        ag_management_data['Ecological Grazing'] = get_ecological_grazing_effect_c_mrj(data, yr_idx)
